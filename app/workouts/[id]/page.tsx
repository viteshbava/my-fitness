...
const WorkoutDetailPage = () => {
  ...
  const [exerciseToRemove, setExerciseToRemove] = useState<WorkoutExerciseWithExercise | null>(null);
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="mb-8">
          ...
          <p className="text-gray-600 dark:text-gray-400">
            Created at {format(new Date(workout.created_at), 'HH:mm')}
          </p>
        </div>
        ...
        {workoutExercises.length === 0 ? (
          <div className="bg-white dark:bg-gray-800 rounded-lg shadow p-12 text-center">
            ...
            <Link
              href={`/workouts/${workoutId}/add-exercise`}
              className="inline-block text-blue-600 hover:text-blue-700 dark:text-blue-400 dark:hover:text-blue-300 cursor-pointer"
            >
